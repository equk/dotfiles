...
echo -e "$gplus copying awesomewm configuration files"
for file in $(find ~/.config/awesome -type f); do
    copy $file
done

echo -e "$gplus copying hyprland configuration files"
for file in $(find ~/.config/hypr -type f); do
    copy $file
done
...
echo -e "$gplus copying waybar configuration files"
for file in $(find ~/.config/waybar -type f); do
    copy $file
done
...
echo -e "$gplus copying tmux configuration files"
for file in $(find ~/.config/tmux/layouts -type f); do
    copy $file
done
copy ~/.config/tmux/tmux.conf
